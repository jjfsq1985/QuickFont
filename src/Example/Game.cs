...
namespace Example
{
    class Game : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
	        ...
	        _mainText = new QFont(@"Fonts\SourceHanSans.ttf", 14, builderConfig);
            _mainTextOptions = new QFontRenderOptions { /*DropShadowActive = true, */Colour = Color.White, WordSpacing = 0.5f};
 
            _benchmarkResults = new QFont("微软雅黑", 14, builderConfig);
                    ...
                    case 0:
                        {
                            ...
                            var stri = _modernQuickFontIntro + "世界";
                            _mainText.EnsureChars(stri);
                            yOffset += _drawing.Print(_mainText, stri, new Vector3(30, Height - yOffset, 0),
